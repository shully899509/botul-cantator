...
async def on_message(message):
    ...
    messages_from_mee6 = ['Să mă iei de cuc {}',
                          ...
                          'Ți-a mai zis cineva ca puți a câcat cu miere, cu un strop de spermă și unul de untură de pește {} ?',
                          ...
                          'Bă {}, cred ca tu ești un mare magician de ai reușit să sari din prezervativu lu tactu în pizda mă-tii, deserta-mi-aș coaiele în gâtu mă-tii!',
                          '{} Să te fut pâna ți s-or strepezi dinții, spaima pulii!',
                          ...
                          '{} Ești apreciat ca cel mai bun muist',
                          'baga-mi-aș pula peste mă-ta-n casă să-i mai fac un handicapat {} !',
                          '{} Să-mi bag pula peste mă-ta în casă sa o dobor, mânca-mi-ai pula de la cotor de curva lindicoasa',
                          ...
                          'Manca-mi-ai puroiul de la hemoroizii curului meu păros {} !',
                          '{} Vezi că iți pute gura a pulă de la 10 km',
                          'Dacă aș avea dinți în cur tu ai avea găuri în limbă {}',
                          'Ba {} tu du-te să faci labă la câcat pâna o să iasă pasta de dinți cu care o să te speli mândru pe gingii',
                          'Ba muie, să faci umbra pulii mele cu nasu {}',
                          ...
                          'Să te bag în pizda mă-tii {}, dar nu de tot, numai cât să-ți rămâna capul cu gura afara sa ma cac în ea',
